...
export const SEO_STYLE_DNA =
  "Bright clean technical environment: white and cool light-gray architectural surfaces, subtle blueprint-blue and cyan accents (#2563EB to #22D3EE family), soft neutral daylight, precision industrial-catalog photography, premium light modern infrastructure-brand aesthetic. No dark voids, no cyberpunk, no neon, no warm gold or ivory tones, no fake text or logos.";
...
export const SEO_IMAGES: SeoImage[] = [
  ...
  },
  {
    ...
    page: "/platform",
    prompt: `Clean overhead three-quarter view of the PODOS Pod docked to a bright technical site pad with precise blueprint-blue utility markings on light concrete: power feed, fiber route, cooling interface — drawn as thin engineering linework on the ground around the unit. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  /* ---------------- /platform/podos-pod ---------------- */
  {
    ...
    prompt: `Hero product photograph of the PODOS Pod, front three-quarter angle, in an enormous bright white technical studio with a subtle blueprint grid floor, soft daylight, crisp reflections, catalog-cover quality. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    id: "pod-scale-humans",
    page: "/platform/podos-pod",
    prompt: `The PODOS Pod in a bright white exhibition hall with two engineers in light-gray workwear standing beside it for true scale (unit is 40 ft long, 8 ft tall), neutral daylight, honest proportions, documentary-clean composition. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    id: "pod-panel-detail",
    page: "/platform/podos-pod",
    prompt: `Tight macro detail of the PODOS Pod's matte-black modular panel seams, service latch, and the edge of the solar roof line, shallow depth of field, bright neutral light, material-quality product photography. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    id: "pod-siting-pad",
    page: "/platform/podos-pod",
    prompt: `The PODOS Pod installed on a fresh light-concrete pad at a tidy industrial site under a bright overcast sky, low fence line and small switchgear cabinet nearby, realistic siting context, clean editorial framing. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  /* ---------------- /platform/syntropic ---------------- */
  {
    ...
    prompt: `Abstract technical visualization of GPU memory pressure: dense translucent blue cubes compressing into a sparser, ordered lattice, rendered as precise glass geometry on a bright white field with fine blueprint gridlines, elegant scientific-figure aesthetic. No hardware, no people. ${SEO_STYLE_DNA}`,
  ...
  },
  {
    ...
    page: "/platform/syntropic",
    prompt: `Minimal abstract render of a data path: a wide stream of fine blue light filaments narrowing through a precise crystalline gate and emerging compact and ordered, on a clean white background with subtle cyan accents, premium scientific illustration. No hardware, no text. ${SEO_STYLE_DNA}`,
  ...
  },
  {
    ...
    page: "/engineering",
    prompt: `Bright engineering-lab bench scene: precision components laid out in a neat grid on white — a copper cold plate, coolant quick-disconnects, a busbar section, fiber cassette, sensor module — top-down catalog photography with thin blueprint-blue callout ticks. No text. ${SEO_STYLE_DNA}`,
  ...
  /* ---------------- /engineering/direct-to-chip-liquid-cooling ---------------- */
  {
    ...
    prompt: `Macro photograph of a direct-to-chip liquid cooling cold plate mounted on a GPU module: machined copper microchannel plate, two coolant fittings with blue anodized collars, clean cabling, bright neutral studio light, extreme technical clarity. No visible brand logos. ${SEO_STYLE_DNA}`,
  ...
  },
  {
    id: "cooling-cdu-row",
    page: "/engineering/direct-to-chip-liquid-cooling",
    prompt: `A coolant distribution unit (CDU) cabinet with clear service panels beside a white rack row inside a bright technical corridor of the PODOS Pod interior: manifolds, flow meters, supply/return piping in orderly runs, cool daylight tones. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    ...
    page: "/engineering/direct-to-chip-liquid-cooling",
    prompt: `Exterior view of dry coolers / heat-rejection units on a light concrete pad beside the PODOS Pod, fan arrays visible, warm-water pipe run connecting them, bright overcast daylight, tidy industrial landscaping, editorial infrastructure photography. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  /* ---------------- /engineering/data-center-power-architecture ---------------- */
  {
    ...
    prompt: `Interior of a bright electrical room: medium-voltage switchgear lineup in light-gray cabinets with closed panels, orderly cable trays overhead, polished concrete floor, cool white lighting with subtle blue indicator accents, utility-grade craftsmanship. No readable labels. ${SEO_STYLE_DNA}`,
  ...
  },
  {
    ...
    page: "/engineering/data-center-power-architecture",
    prompt: `A compact pad-mounted transformer and utility interconnection cabinet on light gravel beside the PODOS Pod, cable trench with covers running between them, bright daylight, chain-link perimeter softly out of focus, believable utility engineering. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    id: "power-busway-run",
    page: "/engineering/data-center-power-architecture",
    prompt: `Interior technical view along a white equipment corridor: overhead busway duct with tap-off boxes feeding rack positions, tidy conduit and cable-tray runs, bright even lighting, precision electrical installation photography. No readable labels. ${SEO_STYLE_DNA}`,
  ...
  /* ---------------- /deploy ---------------- */
  {
    ...
    page: "/deploy",
    prompt: `A mobile crane lowering the PODOS Pod onto a prepared light-concrete pad, rigging taut, two spotters in light-gray safety gear guiding placement, bright morning daylight, clean staging area, professional heavy-lift photography. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    id: "deploy-pad-prep",
    page: "/deploy",
    prompt: `Site-readiness scene before delivery: a freshly cured concrete pad with embedded anchor points and stub-up conduits, surveyor tripod, marked utility trench, bright neutral daylight — an empty stage awaiting the unit. No pod in frame. ${SEO_STYLE_DNA}`,
  ...
  },
  {
    ...
    page: "/deploy",
    prompt: `Commissioning scene at the PODOS Pod's open service bay: an engineer with a rugged tablet checking systems, interior rack glow spilling soft white light, service cover opened on gas struts, bright exterior daylight, believable acceptance-testing moment. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  /* ---------------- /use-cases ---------------- */
  {
    id: "usecase-campus",
    page: "/use-cases",
    prompt: `The PODOS Pod placed discreetly behind a modern university research building with light brick and glass architecture, neat landscaping, students far in the background, bright afternoon light — on-campus AI capacity without a datacenter build. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    id: "usecase-factory",
    page: "/use-cases",
    prompt: `The PODOS Pod beside a bright modern manufacturing plant with white cladding, loading docks in the distance, forklift passing, clean industrial yard, overcast-bright light — compute at the point of production. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    id: "usecase-hospital",
    page: "/use-cases",
    prompt: `The PODOS Pod on a screened utility pad beside a contemporary hospital wing (white facade, glass), discreet placement near existing mechanical equipment, bright clean daylight — data kept on premises. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  },
  {
    ...
    page: "/use-cases",
    prompt: `The PODOS Pod at a remote edge site: high-plains landscape with a small solar array and a telecom mast nearby, crisp morning light, vast sky, the unit self-contained on its pad — believable off-grid-capable siting. ${POD_DNA} ${SEO_STYLE_DNA}`,
  ...
  /* ---------------- /resources/ai-infrastructure-glossary ---------------- */
  {
    ...
    prompt: `Quiet abstract header image: fine blueprint-blue engineering linework — pipe runs, one-line electrical symbols, rack outlines — etched sparsely across a bright white field with one small cyan accent node, minimal and encyclopedic. No text, no readable symbols. ${SEO_STYLE_DNA}`,
    alt: "",

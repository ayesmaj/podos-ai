...
export const JOURNEY = {
  ...
  stages: [
    { n: "01", title: "ENGINEER", body: "One standardized architecture: power, cooling, racks, networking, and operations designed as a single product.", imageId: "engineering-design", tag: "SYSTEM DESIGN" },
    ...
    { n: "03", title: "INTEGRATE", body: "Server racks, fiber, switching, and monitoring are installed and validated before the unit ships.", imageId: "rack-install", tag: "SYSTEMS INTEGRATION" },

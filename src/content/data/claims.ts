...
export const CLAIMS: Record<string, PublicClaim> = {
  ...
  "pod-gpu-capacity": {
    id: "pod-gpu-capacity",
    statement: "Each PODOS Pod is designed for 128 GPUs.",
    shortLabel: "128 GPUs per pod",
    status: "company-target",
    publishable: true,
    requiredQualifier: "designed for",
    approvedBy: "Founder (chat)",
    approvedAt: "2026-08-31",
    notes: "Founder resolved conflict C2 to 128; optimusComponents (was 64) and MEGA SILO math (24→20 pods, so 20 MW = 20 × 1 MW and 2,560 = 20 × 128) updated; dead siteContent.ts (256) deleted.",
  },
  "pod-footprint": {
    id: "pod-footprint",

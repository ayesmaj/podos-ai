 ...
 * what this returns but must never be the authoritative calculator.
 *
 * NOTE: currently UNUSED. The live estimator at /estimate calculates in the
 * browser via src/lib/configurator/estimate.ts. This module is the
 * server-authoritative implementation the master brief requires (§10),
 * kept for the Phase-1 domain layer; wire it behind a server action before
 * any figure is treated as commercially binding.
 *
